...
export const specFor = (node: GraphNode, doc: GraphDocument): NodeSpec => {
  if (node.type === 'regionalInspect') {
    const titles: Record<string, string> = { source: 'Scene Source', flow: 'Dense Motion', validity: 'Motion Validity', cells: 'Motion Cells', tracks: 'Motion Groups', families: 'Motion Families', velocities: 'Velocity Histories', conflicts: 'Motion Conflicts', events: 'Drawing Events', timeline: 'Timing Timeline', review: 'Regional Review' }
